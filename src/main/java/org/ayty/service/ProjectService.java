...
public class ProjectService {
	...
	public List<Project> getProjects() {
		...
		List<Project> list = new Gson().fromJson(convertedObject.get("content"), new TypeToken<List<Project>>() {
		}.getType());
		return list;
	}

	public void postProject(String token, String name, String description, String logo, LocalDate startDate,
			LocalDate endDate) {
	...
	private String toJson(String name, String description, String logo, LocalDate startDate, LocalDate endDate) {
	...
	public void updateProject(Long id, String token, String name, String description, String logo, LocalDate startDate,
			LocalDate endDate) {
